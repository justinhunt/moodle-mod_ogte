...
$string['articlegenerator_instructions'] ="Enter a non-fiction topic in the box below. e.g 'ladybirds' or 'The pros and cons of alcohol.' Then press the 'Generate Article' button. The AI helper will generate a short easy English passage of text suitable for language learners. N.B The AI helper was trained onlu on non-fiction topics. It won't write stories. But it will make up facts and it will often not be truthful.";
